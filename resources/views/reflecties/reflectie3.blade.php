...
@section('content')
      ...
      <div class="fixed-header bg-light">
        ...
        <div class="body-reflectie">
          ...
          <button class="topbar-reflectie-button-left"><a href="{{ url('reflecties/reflectie2') }}">vraag2</button></a>
          <button class="topbar-reflectie-button"><a href="{{ url('reflecties/reflectie4') }}">vraag4</button></a>
      </div>
    </div>
    </div>
  </div>
