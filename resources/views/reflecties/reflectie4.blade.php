...
@section('content')
      ...
      <div class="fixed-header bg-light">
        ...
        <div class="body-reflectie">
          ...
          <button class="topbar-reflectie-button-left"><a href="{{ url('reflecties/reflectie3') }}">vraag3</button></a>
          <button class="topbar-reflectie-button"><a href="{{ url('reflecties/reflectie5') }}">vraag5</button></a>
      </div>
    </div>
    </div>
  </div>
