      ...
      <div class="fixed-header bg-light">
          <div class="container">
            <div class="body-reflectie">
              <div class="previous">
                <button class="topbar-reflectie-button-left"><a href="{{ url('reflecties/reflectie4') }}">Vraag 4</button></a>
              </div>
              <h2 class="text-center test2">Reflectie</h2>
              <div class="next">
              <button class="topbar-reflectie-button"><a href="{{ url('reflecties/reflectie6') }}">Vraag 6</button></a>
            </div>
          </div>
    </div>
    </div>
...
<div class="container">
      ...
      <input type="text" type="text" placeholder="Typ hier uw antwoord" class="Reflectie-input" name="antwoord" id="antwoord">
        <input type="hidden" id="vraagnummer" name="vraagnummer" value="5">
