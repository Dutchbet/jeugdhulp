...
@section('content')
      ...
      <div class="fixed-header bg-light">
        ...
        <div class="body-reflectie">
          ...
          <button class="topbar-reflectie-button-left"><a href="{{ url('reflecties/reflectie6') }}">vraag6</button></a>
          <button class="topbar-reflectie-button"><a href="{{ url('reflecties/reflectie8') }}">vraag8</button></a>
      </div>
    </div>
    </div>
  </div>
