...
@section('content')
      ...
      <div class="fixed-header bg-light">
        ...
        <div class="body-reflectie">
          ...
          <button class="topbar-reflectie-button-left"><a href="{{ url('reflecties/reflectie8') }}">vraag8</button></a>
          <button class="topbar-reflectie-button"><a href="{{ url('reflecties/reflectie10') }}">vraag10</button></a>
      </div>
    </div>
    </div>
  </div>
  <div class="vraagbox-reflectie">
      ...
      <div class="vraagbox-reflectie-text">Welke vragen zijn nog nieti beantwoord?</div>
</div>
